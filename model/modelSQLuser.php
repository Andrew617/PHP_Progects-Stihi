...
class ModelSQLuser {
    ...
    private static $forCreateNewUser = 'INSERT INTO passwords (nick, name, surname, profession, biography, password) VALUES (:nick, :name, :surname, :profession, :biography, :password)';
